...
def calculate_price():
    ...
    min_p = total_sqft * rate['min']
    max_p = total_sqft * rate['max']
    return jsonify({
        ...
        'gst_min':       round(min_p * 0.18),
        'gst_max':       round(max_p * 0.18),
        'total_min_gst': round(min_p * 1.18),
        'total_max_gst': round(max_p * 1.18),
    })
